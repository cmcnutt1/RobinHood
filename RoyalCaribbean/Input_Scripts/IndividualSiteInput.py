...
def get_individual_result_info(driver, ship_name, index_list):
    ...
    for item in index_list:
        ...
        try:
            ...
            if not ("Samplert" in cruise_title):
#or len(port_text_list)<2):
...
if __name__ == "__main__":
    ...
    get_individual_result_info(drive, ship, index_list)
